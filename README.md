...
- served as the Project Lead, consistently initiating tasks, assigning responsibilities, and ensuring deadlines were met. They were also responsible for submitting outputs for Quarters 1, 2, and 4, contributed to coding, and led the development of the final paper and assisted in presentation preparation.

**#22 Pedernal, Lucas Íñigo S.**  
- acted as the Main Programmer, handling the system’s development throughout all four quarters, including backend coding, feature implementation, and debugging.

**#23 Privado, Louise Janine B.** 
- focused on Documentation and Presentation, primarily proofreading the paper and creating and designing the group’s presentation slides.

**#24 Rafael, Roswyn Drawde A.**  
- worked as the Tester and Support Developer, assisting in coding and troubleshooting, leading system testing, and submitting the Quarter 3 output.

**#25 Reyes, Auric Geranyl**  
- contributed as a Support Programmer, assisting in coding tasks across the project.  

## 8. References / Background Research (APA Format)

Bro Code. (2024, May 19). STRUCTS in C++ explained 🏗️ [Video]. YouTube.https://m.youtube.com/watch?v=ObUUe9ujYoY&pp=iggCQAE%3D 

Curry, C. (2019, January 29). C++ programming tutorial 20 - bool data type [Video]. YouTube. https://youtu.be/Cz4fl-TUjVk?si=WzwOdMbliGnz70ha

Curry, C. (2022, December 24). Reading and writing to files (ifstream and ofstream) - C++ tutorial 25 [Video]. YouTube. https://youtu.be/Su3a6vTtTFw?si=LDuiggM93ibWTNLF
...
Kulyyev, Y. (2017, February 21). C++ tutorials - void function [Video]. YouTube.https://youtu.be/-NKUKkyQNKc?si=GTui7pGQADsx65RN 

Programiz. (n.d.). C++ vectors. Retrieved April 23, 2026, from https://www.programiz.com/cpp-programming/vectors

Selected Topics in IT. (2021, May 24). C++ 13: Using cin.ignore() [Video]. YouTube.https://youtu.be/3h5wt2rUZHw?si=zxGlXnEK23BieWtU
